...
- `docs/reports/` — 48 individual findings, from initial file-format analysis through fully decompiled game formulas (economy, combat, movement, diplomacy, AI dispatch, and more).
