...
- **Who withdraws from city stocks between ticks.** The 111 residuals are one-directional, which fits the AI auto-resupply path (`53090–53156`), but it is not traced.
